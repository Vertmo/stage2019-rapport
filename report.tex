...
code { AMOUNT; PUSH mutez 5000000; COMPARE; GT;
       IF { FAIL } {}; # Check enough mutez were sent
       DUP; DIP { CDR; DUP }; CAR; DUP;
       DIP {
             GET; ASSERT_SOME; # Check the string sent is a key of the map
             PUSH int 1; ADD; SOME # Increment the value associated by one
           };
       UPDATE; NIL operation; PAIR # Update the storage
     }
\end{lstlisting}
...
\inferrule* [left=(instr\_assign)]
    { E \vdash rhs / val \rightarrow val' \\ E \vdash_{lhs} / val' \rightarrow val'' }
...
Apart from assignments, the instruction language is also completed with a few specific instructions: for instance, the \lstinline{drop} instruction, which behave similarly to the !DROP! instruction in Michelson.
...
\inferrule* [left=(rhs\_match)]
    ...
    { G \vdash_{rhs} match\:var\:with\:cons_1\:var_1 \rightarrow rhs_1 | \ldots | cons_k\:var_k \rightarrow rhs_k\:end : rty' \Rightarrow ty }
$$
...
\inferrule* [left=(rhs\_match\_next)]
    { cons \neq cons' \\
      E \vdash_{rhs} match\:var\:with\:branches\_rhs\:end / \{ var = (cons\:val' : vty) \} \rightarrow val' }
    { E \vdash_{rhs} match\:var\:with\:cons'\:var' \rightarrow rhs | <branches\_rhs> end / \{ var = (cons\:val' : vty) \} \rightarrow val }
$$
...
\inferrule* [left=(rhs\_list)]
    { }
    { E \vdash_{rhs} [ var_1 ; .. ; var_n ] / \{ var_1 = val_1 ; .. ; var_n = val_n \} \rightarrow [ val_1 ; .. ; val_n ] }
$$
...
\inferrule* [left=(ins\_list\_match\_cons)]
    { \{ var_1 = val_1 :: tl \} @ rval = rval' \\ \{ var_1 = val_1 ; var_2 = tl \} @ rval = rval'' \\ E \vdash_{ins} I_2 / rval'' \rightarrow val }
    { E \vdash_{ins} match\:var\:with [] \rightarrow I_1 | var_1 :: var_2 \rightarrow I_2\:end / rval' \rightarrow val }
$$
...
\inferrule* [left=(get\_next)]
   ...
   { E \vdash_{rhs} var[x] / \{ var = { val_1 \mapsto val_1' ; mval } ; x = val_2 \} \rightarrow val'_2 }
 $$
...
\begin{lstlisting}[language=Albert,numbers=left]
